...
-- Tu respuesta aquí
SELECT COUNT(*) FROM usuarios_lenguajes WHERE edad>28 ORDER BY edad 
...
-- Tu respuesta aquí
SELECT lenguaje, COUNT(lenguaje) FROM usuarios_lenguajes WHERE edad<30 GROUP BY lenguaje LIMIT 1
...
-- Tu respuesta aquí
SELECT nombre,lenguaje FROM usuarios_lenguajes WHERE lenguaje!="" ORDER BY nombre
...
-- Tu respuesta aquí
SELECT * FROM usuarios_lenguajes WHERE lenguaje!="" AND edad>25 AND edad<35
...
-- Tu respuesta aquí
SELECT nombre,COUNT(lenguaje) FROM usuarios_lenguajes WHERE lenguaje!="" GROUP BY nombre

-- Ejercicio 22: Encontrar el lenguaje con más caracteres.
-- Tu respuesta aquí
SELECT lenguaje,length(lenguaje) FROM usuarios_lenguajes WHERE lenguaje!="" ORDER BY length(lenguaje) DESC LIMIT 1
...
-- Tu respuesta aquí
SELECT nombre, lenguaje,length(lenguaje) FROM usuarios_lenguajes WHERE lenguaje!="" AND edad<30 ORDER BY length(lenguaje) DESC LIMIT 1


-- Ejercicio 27: Seleccionar los usuarios que tienen al menos un lenguaje asociado y mostrar sus emails.
-- Tu respuesta aquí
SELECT nombre, email FROM usuarios_lenguajes WHERE lenguaje!=""
...
-- Tu respuesta aquí
SELECT nombre, lenguaje,length(lenguaje) FROM usuarios_lenguajes WHERE lenguaje LIKE "J%" ORDER BY length(lenguaje) ASC LIMIT 1


-- Ejercicio 30: Encontrar el usuario con edad mayor a 30 y que sabe el lenguaje con menos caracteres.
-- Tu respuesta aquí
SELECT nombre, lenguaje,length(lenguaje) FROM usuarios_lenguajes WHERE edad<30 ORDER BY length(lenguaje) ASC LIMIT 1


-- Ejercicio 31: Seleccionar los usuarios que saben al menos un lenguaje y ordenarlos por nombre de lenguaje. 
-- Tu respuesta aquí
SELECT * FROM usuarios_lenguajes WHERE lenguaje!="" ORDER BY lenguaje ASC

-- Ejercicio 32: Contar cuántos usuarios tienen una edad entre 20 y 25 años y saben al menos un lenguaje. 
-- Tu respuesta aquí
SELECT COUNT(*) FROM usuarios_lenguajes WHERE lenguaje!="" AND edad>20 AND edad<25
...
-- Tu respuesta aquí
SELECT lenguaje,length(lenguaje) FROM usuarios_lenguajes WHERE lenguaje!="" AND edad>=30 ORDER BY length(lenguaje) DESC LIMIT 1

-- Ejercicio 35: Seleccionar los usuarios y mostrar la diferencia entre su edad y la edad promedio de todos los usuarios
-- Tu respuesta aquí
SELECT nombre, (edad - (SELECT AVG(edad) FROM usuarios_lenguajes)) FROM usuarios_lenguajes 
    /* Utilizando subconsultas*/
...
-- Tu respuesta aquí
SELECT *, (SELECT SUM(edad) FROM usuarios_lenguajes) FROM usuarios_lenguajes 
    /* Utilizando subconsultas*/
